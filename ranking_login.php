        ...
        <div class='col s12 center-align'>
            <div class='formulario'>
                <form action="" method="post">
                    ...
                    <input type="submit" name="btnLogar" value="Logar" class="btn">
                </form>     
                <form action="ranking_esquecisenha.php" method="post" >
                    <input type="submit" name="btnReset" value="Redefinir Senha" class="btn">
                </form>

                <form action="ranking_criarconta.php" method="post"> 
                    <input type="submit" name="btncadastro" value="Criar Conta" class="btn">
                </form>
            </div>
        </div>
    </div>
